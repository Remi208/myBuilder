class Select {
  ...
  addListeners(select, customSelect) {
    ...
    customSelect.addEventListener('click', function (event) {
      if($(this).hasClass(options.customSelectActiveClassName)){
        $(this).removeClass(options.customSelectActiveClassName);
      } else {
        $('.select').removeClass(options.customSelectActiveClassName);
        $(this).addClass(options.customSelectActiveClassName);
      }
